...
_**Don't get stuck:**_ In your own words. Aloud. Draw. Examples. Pseudocode. Brute force first. Manually. Patterns. Heuristic. Base case and build. Try with just one item first (even for an iterative solution). See if sorting helps you find a pattern. Data structure alphabet.
